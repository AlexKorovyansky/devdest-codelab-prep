...
<mark>**ЗАДАЧА 1.1:** Реализовать программу, выводящую на консоль "Devfest Siberia 2016 rulezzzz" ~ раз в 1000 миллисекунд. Если вы справились с этой задачей значит вы корректно настроили окружение и готовы двигаться вперед к реализации нашего умного кресла!</mark>
